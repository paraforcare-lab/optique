...
const DOCUMENT_LABELS: Record<string, Record<string, DocumentLabels>> = {
  fr: {
    facture: {
      ...
      footer: { generatedBy: 'Généré par OptiGestion' },
  ...
  en: {
    facture: {
      ...
      footer: { generatedBy: 'Generated by OptiGestion' },
  ...
  ar: {
    facture: {
      ...
      footer: { generatedBy: 'تم الإنشاء بواسطة OptiGestion' },
...
<body>
<div class="page">
  <div class="watermark">${data.watermarkText || 'OptiGestion'}</div>
